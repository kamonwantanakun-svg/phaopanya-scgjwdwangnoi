...
|:---:|:---|:---|:---|
| 0 | person_id | String (P-xxx) | Primary Key |
...
| Index | ชื่อคอลัมน์ | ประเภท | คำอธิบาย |
|:---:|:---|:---|:---|
| 0 | alias_id | String (A-xxx) | Primary Key |
...
| Rule | เงื่อนไข | ผลลัพธ์ |
|:---:|:---|:---|
| 1 | No Geo | สร้าง Geo ใหม่ → CREATE_NEW |
| 2 | Geo far (>100m) | สร้าง Geo ใหม่ |
| 3 | Person not found | สร้าง Person ใหม่ |
| 4 | Full Auto Match (≥90) | AUTO_MATCH |
| 5 | Partial Match | ขึ้นกับคะแนน |
| 6 | Place not found | สร้าง Place ใหม่ |
| 7 | Low confidence | NEEDS_REVIEW |
| 8 | Default | NEEDS_REVIEW |
